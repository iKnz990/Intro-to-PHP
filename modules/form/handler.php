  ...
  <body>
    <div class="content">
      <div class="content form-container">
        ...
        <div class="form-group">
          <p>We have you listed as a
            <?php echo $academic_standing; ?> starting this fall.
          </p>
        </div>

        <div class="form-group">
          <p>You have declared
            <?php echo $program; ?> as your major.
          </p>
        </div>

        <div class="form-group">
          <p>Based upon your responses we will provide the following information in our confirmation email to you at
        ...
        <div class="form-group checkbox-group">
          <ul>
            <?php if (isset($contact_info)) {
              echo "<p>Based on your respose we will send additional information to $customer_email.</p>";
            } ?><br>
            <?php if (isset($contact_advisor)) {
              echo "<p>Based on your respose a $program advisor will reach out to you.</p>";
            } ?>
          </ul>
        </div>
